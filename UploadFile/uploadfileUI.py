...
def upioad_file(top, config):
    def upioad_file_logic():
        ...
        if value1 == '选择附件位置':
            ...
            try:
                massge = mainB(value1, value2, value3, value4, value5, value6, value7,value8)
...
7、上传多个测试集，中间用+号隔开例如：1234+5678+8520
8、FlieStatus如果已经有附件是否上传
'''
